 ...
 */
final class Version20180716125441 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad CHANGE images images TINYTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad CHANGE images images VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
